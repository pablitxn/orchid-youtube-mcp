...
from src.infrastructure.telemetry.logger import get_logger
...
class LogContext:
    ...
    def __enter__(self) -> "LogContext":
        ...
        from src.infrastructure.telemetry.logger import get_log_context, log_context_var
    ...
    def __exit__(self, *args: Any) -> None:
        ...
        from src.infrastructure.telemetry.logger import log_context_var
